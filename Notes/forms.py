...
class CourseForm(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        """
        Dynamically filters the term-choices available to the user 
        when associating a course with a term, so far as the terms available
        are those associated with the user.
        """
...
class ClassNoteForm(forms.ModelForm):
    """
    Form for creating a new ClassNote object i.e the actual note
    """
    ...
    class Meta():
        """
        Fields of the ClassNote model to appear in the form.
        """
        model = ClassNote
        fields = ('title','body','course')
...
class UpdateNoteForm(forms.ModelForm):
    ...
    class Meta():
        """
        Fields of the ClassNote model that users can update.
        """
        model = ClassNote
        fields = ('title','body','course')
...
class SearchBarForm(forms.ModelForm):
    ...
    class Meta():
        """
        Allows user to search using the title.
        """
        model = ClassNote
        fields = ('title',)
